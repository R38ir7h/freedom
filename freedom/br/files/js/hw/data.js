var data = [
	...
	[
		...
		{
			index: 3,
			name: "Música de Guerra da Defesa",
			ranks: 5,
			desc: "O Grito de Guerra aumenta a sua Defesa em <span class='tooltip-value'>#</span> mais <span class='tooltip-value'>#%</span> da sua Defesa base.\n\n<b>You can increase the level of talent using runes.</b>",
			rankInfo: [5, 10, 15, 20, 25],
		...
		},
		{
			...
			ranks: 3,
			desc: "Aumenta o dano bônus do primeiro e segundo golpes do Corte do Relâmpago que acertarem em <span class='tooltip-value'>#%</span> e <span class='tooltip-value'>#%</span>, respectivamente.",
			rankInfo: [2, 4, 6],
			rankInfo2: [4, 8, 12],
		},
		{
	...
	[
		...
		},
		{
			...
			ranks: 3,
			desc: "Aumenta em <span class='tooltip-value'>#%</span> a chance para que o segundo golpe do Corte do Relâmpago retardar o alvo.",
			rankInfo: [15, 30, 45],
		},
		{
			index: 5,
		...
		},
		{
			...
			ranks: 5,
			desc: "Cada acumulação da Posição de Sangue Raivoso aumenta adicionalmente a sua Saúde Máxima em <span class='tooltip-value'>#%</span> extra <span class='tooltip-value'>#</span>.",
			rankInfo: [0.3, 0.6, 0.9, 1.2, 1.5],
	...
	[
		...
		{
			index: 11,
			name: "Agitação de Música de Guerra",
			ranks: 3,
			desc: "O Grito de Guerra aumenta adicionalmente o seu Ataque em <span class='tooltip-value'>#</span> e o seu Ataque em <span class='tooltip-value'>#%</span>.",
			rankInfo: [20, 40, 60],
			rankInfo2: [0.5, 1, 1.5],
			parent: 4,
		},
		{
			...
			name: "Uivo",
			ranks: 3,
			desc: "Aumenta a duração do Rugido Ameaçador em <span class='tooltip-value'>#</span> segundo(s) e reduz a Resistência Física dos alvos em <span class='tooltip-value'>#</span>.\n\n<b>Você pode aumentar o nível de talento usando runas.</b>",
			rankInfo: [2, 4, 6],
			rankInfo2: [10, 20, 30],
			parent: 6,
		},
		...
		},
		{
			...
			ranks: 3,
			desc: "Aumenta a duração do Impacto Fulminante em <span class='tooltip-value'>#</span> segundo(s).\n\n<b>Você pode aumentar o nível de talento usando runas.</b>",
			rankInfo: [2, 4, 6],
		},
		{
			index: 18,
		...
		},
		{
			...
			ranks: 4,
			ranksnw: 3,
			desc: "Aumenta a Chance Crítica do segundo ataque do Corte do Trovão em <span class='tooltip-value'>#%</span> e reduz o intervalo de uso da habilidade em <span class='tooltip-value'>#</span> segundo(s).\n\n<b>Você pode aumentar o nível de talento usando runas.</b>",
			rankInfo: [2, 4, 5, 8],
