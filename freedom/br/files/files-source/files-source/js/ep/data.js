var data = [
    ...
    [
        ...
        },
        {
            ...
            ranks: 4,
			desc: "Sanación desencadena el estado de Protección Natural, que incrementa la cantidad de Salud restablecida por tus habilidades de sanación en <span class='tooltip-value'>#%</span> por 10 segundos.",
            rankInfo: [5, 10, 15, 20],
			parent: [0],
        },
        {
        ...
        },
        {
            ...
            ranks: 3,
			ranksnw: 2,
			desc: "Reduce la reactivación de Luz de Sanación en <span class='tooltip-value'>#</span> segundo(s).",
            rankInfo: [1, 2, 3],
        },
        {
            index: 16,
        ...
        },
        {
            ...
            ranks: 3,
			desc: "Sanación restablece una cantidad de Maná del objetivo igual al <span class='tooltip-value'>#%</span> de tu Maná máximo a los objetivos afectados por Luz de Sanación o Protección Natural.\n\n<b>Se puede aumentar el nivel de talento usando runas.</b>",
            rankInfo: [1, 1.5, 2],
        },
        {
            index: 22,
            name: "Poder Sagrado",
            ranks: 3,
			desc: "Incrementa el daño de base de tus habilidades ofensivas en <span class='tooltip-value'>#%</span> luego de que lanzas Sanación, Luz de Sanación, o Luz Divina. Este efecto dura 20 segundos, se acumula hasta 3 veces, y termina luego de que lanzas exitosamente un ataque.\n\n<b>Se puede aumentar el nivel de talento usando runas.</b>",
            rankInfo: [6, 8, 10],
        },
        {
            index: 23,
        ...
        },
        {
            ...
            ranks: 2,
			ranksnw: 1,
			desc: "<span class='tooltip-value' style='font-weight:normal;'>#</span><span class='left'><span class='tooltip-value'>#</span> Maná</span><span class='right'>Tiempo de hechizar: 1 segundos</span>\n<span class='left'>Defensa</span><span class='right'>Reactivación: 30 segundos</span>\n<span class='left'>Bendición objetivo único</span><span class='right'>Alcance: 18 metros</span>\n\nSólo aquellos que mantienen su fe frente a un gran peligro recibirán ayuda Divina. Le concede el efecto de Escudo Divino al objetivo, lo que absorbe el 80% de daño a recibir por <span class='tooltip-value'>#</span> segundos. El escudo puede absorber una cantidad de daño igual a <span class='tooltip-value'>#%</span> de la Salud máxima del objetivo.\n\n<b>Se puede aumentar el nivel de talento usando runas.</b>",
        ...
        {
            index: 31,
            name: "Luz de Naturaleza",
            ranks: 3,
			desc: "Luz de Sanación tiene una posibilidad del <span class='tooltip-value'>#%</span> de restablecer la cantidad total de Salud inmediatamente al ser lanzado sobre un objetivo afectado por Protección Natural.",
            rankInfo: [20, 40, 60],
        },
        {
            index: 33,
        ...
        },
        {
            ...
            name: "Llegada",
            ranks: 3,
			desc: "Incrementa la cantidad de Salud restablecida por Armonía Angelical en <span class='tooltip-value'>#%</span> y reduce su reactivación en <span class='tooltip-value'>#</span> segundos. También reduce la reactivación de Luz de Sanctuario en <span class='tooltip-value'>#</span> segundos por punto en este talento.",
            rankInfo: [5, 10, 15],
            rankInfo2: [1, 2, 3],
			rankInfo3: [20, 40, 60],
        },
    ...
    [
        {
            ...
            ranks: 5,
			ranksnw: 2,
			desc: "Golpe Divino inflige más daño extra igual a <span class='tooltip-value'>#</span> más <span class='tooltip-value'>#%</span> de tu Dominio de Luz.\n\n<b>Se puede aumentar el nivel de talento usando runas.</b>",
        ...
        },
        {
            ...
            ranks: 5,
			ranksnw: 2,
			desc: "Incrementa la cantidad de Salud restablecida por Bendiciones de Vida en <span class='tooltip-value'>#%</span> y la Precisión de tus habilidades de Luz en <span class='tooltip-value'>#</span>.",
            rankInfo: [2, 4, 6, 8, 10],
            rankInfo2: [10, 20, 30, 40, 50],
        },
        {
        ...
        },
        {
            ...
            ranks: 4,
			ranksnw: 1,
			desc: "<span class='tooltip-value' style='font-weight:normal;'>#</span><span class='left'><span class='tooltip-value'>#</span> Maná</span><span class='right'>Tiempo de hechizar: 1 segundos</span>\n<span class='left'>El daño leve</span><span class='right'>Reactivación: 5 segundos</span>\n<span class='left'>Ataque objetivo único</span><span class='right'>Alcance: 18 metros</span>\n\nLos criminales sólo merecen castigo. Inflige el 100% de tu base de Ataque más <span class='tooltip-value'>#</span> de daño extra. Inflige el efecto de Luz de Castigo al objetivo, lo que reduce su Resistencia de Luz en 8 por 15 segundos. Se acumula 5 veces.\n\n<b>Se puede aumentar el nivel de talento usando runas.</b>",
			rankInfo: ['<span class="req">Requiere que el personaje sea Nivel 30</span>\n\n', '<span class="req">Requiere que el personaje sea Nivel 45</span>\n\n', '<span class="req">Requiere que el personaje sea Nivel 60</span>\n\n', '<span class="req">Requiere que el personaje sea Nivel 75</span>\n\n'],
        ...
        },
        {
            ...
            name: "Retribución",
            ranks: 4,
			desc: "Incrementa el daño de base de tus habilidades ofensivas de Luz en <span class='tooltip-value'>#%</span> mientras estás afectado por Protección Natural o Luz de Sanación.\n\n<b>Se puede aumentar el nivel de talento usando runas.</b>",
            rankInfo: [5, 10, 15, 20],
        },
        {
            index: 23,
        ...
        },
        {
            ...
            name: "Castigo",
            ranks: 2,
			desc: "Incrementa el daño extra de Castigo Divino en <span class='tooltip-value'>#%</span>. Castigo Divino desencadena el efecto de Protección Natural, que incrementa la cantidad de Salud restablecida por tus habilidades de sanación en 20% por <span class='tooltip-value'>#</span> segundos.\n\n<b>Se puede aumentar el nivel de talento usando runas.</b>",
            rankInfo: [10, 15],
			rankInfo2: [10, 15],
			parent: 19,
        },
    ...
    [
        ...
        {
            index: 22,
            name: "Arroyo Devorador",
            ranks: 3,
			desc: "Tus hechizos ofensivos de Agua adquieren una posibilidad del <span class='tooltip-value'>#%</span> de aturdir a objetivos ralentizados por 3 segundos.\n\n<b>Se puede aumentar el nivel de talento usando runas.</b>",
            rankInfo: [7, 14, 21],
        },
        {
            index: 23,
        ...
        },
        {
            ...
            name: "Condena",
            ranks: 3,
			desc: "Incrementa la cantidad de Maná que el objetivo de Juicio Divino pierde en <span class='tooltip-value'>#</span> Atrapa a objetivos ralentizados por <span class='tooltip-value'>#</span> segundos.",
            rankInfo: [200, 400, 600],
			rankInfo2: [3, 4, 5],
        },
        {
