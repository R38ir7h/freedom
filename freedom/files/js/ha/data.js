var data = [
	...
	[
		...
		{
			index: 7,
			name: "Pain of Nightmare",
			ranks: 3,
			desc: "Grants Nightmare Termination a <span class='tooltip-value'>#%</span> chance to not consume any Agony Orbs.\n\n<b>You can increase the level of talent using runes.</b><span class='tooltip-value'>#</span>",
			rankInfo: [20, 40, 60],
			rankInfo2: ['', '', '<div class="runelvl">\n\n\n<br>Level: 4/3 (need rune)\n\n<br><br>Grants Nightmare Termination a <span class="tooltip-value">80%</span> chance to not consume any Agony Orbs.</div>'],
		},
		{
			index: 8,
			...
			},
		{
			...
			rankInfo: [10, 20],
			rankInfo2: [2, 4],
			rankInfo3: ['', '<div class="runelvl">\n\n\n<br>Level: 3/2 (need rune)\n\n<br><br>Dark Nightmare reduces the target\'s Resistances by an additional <span class="tooltip-value">30</span> and its duration is increased by <span class="tooltip-value">6</span> second(s).</div>'],
		},
		{
			index: 34,
		...
		},
		{
			...
			ranks: 3,
			desc: "Increases the bonus damage of your offensive Dark skills by <span class='tooltip-value'>#%</span>.\n\n<b>You can increase the level of talent using runes.</b><span class='tooltip-value'>#</span>",
			rankInfo: [10, 20, 30],
			rankInfo2: ['', '', '<div class="runelvl">\n\n\n<br>Level: 4/3 (need rune)\n\n<br><br>Increases the bonus damage of your offensive Dark skills by <span class="tooltip-value">40%</span>.</div>'],
		},
		{
			index: 42,
			name: "Venomous Blade",
		...
		},
		{
			...
			ranks: 1,
			ranksnw: 1,
			desc: "<span class='tooltip-value'>#</span><span class='left'>604 Mana</span><span class='right'>Cast time: 2 seconds</span>\n<span class='left'>Dark damage</span><span class='right'>No cooldown</span>\n<span class='left'>Multi-target attack</span><span class='right'>Short Range</span>\n\nFinisher skills have a chance to enable you to use Mutilation based on Agony Orbs or Blast Orbs. 0/1/2/3/4 Agony Orbs have a 10%/20%/30%/40%/50% chance to enable the use of this skill. Lasts for 45 seconds. This effect disappears after you use Mutilation once. Strikes up to 18 targets four times in a 90 degree arc. Each strike gains an additional 2% Crit Chance. Each strike deals 85% of your Attack plus 1219 bonus damage, the last strike cause. The target loses 1% of its max Health per second, and is slowed by 20% for 10 seconds.",
	...
	[
		...
		},
		{
			...
			name: "Pursuit",
			ranks: 3,
			desc: "Increases the duration of Deadly Chaser's effect by <span class='tooltip-value'>#</span> second(s). Deadly Chaser reduces the movement speed of targets affected by Hunting Mark by an additional <span class='tooltip-value'>#%</span>.",
			rankInfo: [1, 2, 3],
			rankInfo2: [8, 16, 24],
		},
		{
		...
		},
		{
			...
			rankInfo: [1, 2, 3],
			rankInfo2: [3, 6, 9],
			rankInfo3: ['', '', '<div class="runelvl">\n\n\n<br>Level: 4/3 (need rune)\n\n<br><br>Each Blast Orb increases your Crit damage by an additional <span class="tooltip-value">4%</span>. Increases the duration of Blast Orbs by <span class="tooltip-value">12</span> seconds.'],
		},
		{
			index: 21,
			...
			rankInfo: [2, 4, 6],
			rankInfo2: ['', '', '<div class="runelvl">\n\n\n<br>Level: 4/3 (need rune)\n\n<br><br>Blade of Hypnosis silences target for <span class="tooltip-value">8</span> seconds or until the target takes 3 hits.'],
		},
		{
			index: 22,
		...
		},
		{
			...
			name: "Nightmare Seal",
			ranks: 3,
			desc: "Gives your Finisher skills a <span class='tooltip-value'>#%</span> chance to trigger the Blast Orbs' effect without consuming any.",
			rankInfo: [15, 30, 45],
		},
		{
			index: 26,
		...
		{
			index: 31,
			name: "Compound Blades",
			ranks: 2,
			desc: "Increases the Crit Chance of your Finisher skills by <span class='tooltip-value'>#%</span> and increases their bonus damage by <span class='tooltip-value'>#%</span>.",
			rankInfo: [1, 2],
			rankInfo2: [10, 20],
		},
		{
			...
			rankInfo: [4, 6, 8],
			rankInfo2: [10, 20, 30],
			rankInfo3: ['', '', '<div class="runelvl">\n\n\n<br>Level: 4/3 (need rune)\n\n<br><br>While you are slowed, Pitch slows the target by a rate equal to your movement speed reduction for <span class="tooltip-value">10</span> seconds. Has a <span class="tooltip-value">40%</span> chance to remove the slow effect on you.'],
		},
		{
			index: 34,
		...
		},
		{
			...
			rankInfo: [15, 30, 45],
			rankInfo2: [5, 10, 15],
			rankInfo3: ['', '', '<div class="runelvl">\n\n\n<br>Level: 4/3 (need rune)\n\n<br><br>Flair. Mutilation, Imperiling Hack, and Shadow Bites have a chance to reduce the target\'s Evasion by <span class="tooltip-value">60</span> and Max Health by <span class="tooltip-value">20%</span> for 8 seconds. With 1/2/3/4 Blast Orbs, the chance for this effect to occur is 15%/30%/45%/60%.'],
		},
		{
			index: 38,
			...
			rankInfo2: [15, 30],
			rankInfo3: [10, 15],
			rankInfo4: ['', '<div class="runelvl">\n\n\n<br>Level: 3/2 (need rune)\n\n<br><br>Increases the duration of Vicious Intention by <span class="tooltip-value">6</span> seconds. If Assassinate, Throat Seal, or Gouge land a Crit while Vicious Intention is active, the target takes <span class="tooltip-value">45%</span> additional damage from subsequent Physical and Dark attacks for <span class="tooltip-value">20</span> seconds.'],
		},
		{
			index: 41,
			...
			rankInfo: [2, 4, 6],
			rankInfo2: [10, 20, 30],
			rankInfo3: ['', '', '<div class="runelvl">\n\n\n<br>Level: 4/3 (need rune)\n\n<br><br>Increases the durations of Shadowbreak and Deputy of Death by <span class="tooltip-value">8</span> seconds. While Deputy of Death is active, the Accuracy of skills with multiple strikes is increased by <span class="tooltip-value">40</span>.'],
		},
		{
			index: 43,
			name: "Prohibition",
		...
		},
		{
			...
			ranks: 1,
			ranksnw: 1,
			desc: "<span class='tooltip-value'>#</span><span class='left'>559 Mana</span><span class='right'>Cast time: 2 seconds</span>\n<span class='left'>Physical damage</span><span class='right'>No cooldown</span>\n<span class='left'>Single-target attack</span><span class='right'>Short Range</span>\n\nFinisher skills have a chance to enable you to use Imperiling Hack based on Agony Orbs or Blast Orbs. 0/1/2/3/4 Blast Orbs have a 10%/20%/30%/40%/50% chance to enable the use of this skill. Lasts for 45 seconds. This effect disappears after you use Imperiling Hack once. Strikes the target four times. Each hit's Crit damage is increased by 4%/6%/8%/10%, respectively, the last strike generates a point of Blast Orb. Each hit deals 80% of your base Attack, plus 1396 bonus damage.",
			rankInfo: ['<span class="req">Requires character to be Lv75</span>\n\n'],
		},
		{
			index: 47,
	...
	[
		{
			...
			rankInfo3: ['', '', '', '', '<div class="runelvl">\n\n\n<br>Level: 6/5 (need rune)\n\n<br><br>Reduces the cooldown of Stalking Shadow by <span class="tooltip-value">18</span> seconds. Increases the Evasion bonus of Stalking Shadow by <span class="tooltip-value">120%</span>.'],
		},
		{
			index: 4,
			name: "Ghost Shadow",
			...
			rankInfo2: ['', '', '', '', '<div class="runelvl">\n\n\n<br>Level: 6/5 (need rune)\n\n<br><br>Increases your movement speed by <span class="tooltip-value">45%</span> while Stalking Shadow is active.'],
		},
		{
			index: 5,
			name: "Throat Cut",
		...
		},
		{
			...
			rankInfo: [3, 4, 5, 6],
			rankInfo2: ['', '', '', '<div class="runelvl">\n\n\n<br>Level: 5/4 (need rune)\n\n<br><br>Throat Seal and Thrust of Pain drain the target\'s Mana by <span class="tooltip-value">7%</span> and deals 50% of the amount drained as damage to the target. Note: this effect only applies to Player vs. Player combat.'],
		},
		{
			index: 9,
		...
		},
		{
			...
			rankInfo: [3, 6, 9],
			rankInfo2: [20, 40, 60],
			rankInfo3: ['', '', '<div class="runelvl">\n\n\n<br>Level: 4/3 (need rune)\n\n<br><br>Reduces the cooldown of Deadly Chaser by <span class="tooltip-value">12</span> seconds. It increases your movement speed by an additional <span class="tooltip-value">80%</span>.'],
			parent: 5,
		},
		{
			index: 14,
			...
			rankInfo: [20, 40, 60],
			rankInfo2: ['', '', '<div class="runelvl">\n\n\n<br>Level: 4/3 (need rune)\n\n<br><br>Reduces the cooldown of Swift Evasion by <span class="tooltip-value">80</span> seconds.'],
			parent: 6,
		},
		{
			index: 15,
			...
			rankInfo2: [2, 4, 6, 8],
			rankInfo3: ['', '', '', '<div class="runelvl">\n\n\n<br>Level: 5/4 (need rune)\n\n<br><br>Reduces the cooldown of Shadow Protection by <span class="tooltip-value">75</span> seconds, and increases its duration by <span class="tooltip-value">10</span> seconds. <span class="tooltip-value">Dispels all controlling effects above Lv5.</span>'],
		},
		{
			index: 17,
			name: "Still Shadow",
		...
		},
		{
			...
			name: "Ghost Image",
			ranks: 1,
			desc: "While Shadow of Gale is active, you gain immunity to slowing and ensnaring effects.",
			rankInfo: [],
			parent: 14,
		},
		{
		...
		},
		{
			...
			rankInfo: [10, 20, 30],
			rankInfo2: [4, 8, 12],
			rankInfo3: ['', '', '<div class="runelvl">\n\n\n<br>Level: 4/3 (need rune)\n\n<br><br>Increases the effects of Vicious Intention and Swift Evasion by <span class="tooltip-value">40%</span> while you are stealthed. Increases the range of Blade of Hypnosis by <span class="tooltip-value">16</span> meters.'],
		},
		{
			index: 33,
			...
			rankInfo: [1, 2, 3],
			rankInfo2: ['', '', '<div class="runelvl">\n\n\n<br>Level: 4/3 (need rune)\n\n<br><br>Each Agony Orb and Blast Orb increases your movement speed by <span class="tooltip-value">4%</span>.'],
		},
		{
			index: 35,
			...
			rankInfo2: [6, 12, 18],
			rankInfo3: [9, 12, 15],
			rankInfo4: ['', '', '<div class="runelvl">\n\n\n<br>Level: 4/3 (need rune)\n\n<br><br>Focused Maneuver is triggered each time you enter stealth or gain a bonus to your movement speed. Focused Maneuver increases your Accuracy by <span class="tooltip-value">60</span> and your Evasion by <span class="tooltip-value">24</span> for <span class="tooltip-value">18</span> seconds.'],
		},
		{
			index: 37,
		...
		{
			index: 38,
			name: "Advanced Freedom of Wind",
			ranks: 2,
			desc: "Reduces the cooldown of Freedom of Wind by <span class='tooltip-value'>#</span> seconds. It increases your movement speed by 50%, and grants you immunity to ensnare and slow effects for <span class='tooltip-value'>#</span> seconds.",
			rankInfo: [10, 20],
			rankInfo2: [2, 4],
			parent: 21,
		},
