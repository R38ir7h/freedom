var data = [
	...
	[
		...
		{
			index: 22,
			name: "Blood Burn Strike",
			ranks: 3,
			desc: "Increases the base damage of Lurking Sting by <span class='tooltip-value'>#%</span> and drains <span class='tooltip-value'>#%</span> of your current Health. The second attack deals damage equal to <span class='tooltip-value'>#%</span> of your current Health.",
			rankInfo: [10, 20, 30],
			rankInfo2: [1, 2, 3],
			rankInfo3: [2, 4, 6],
			parent: 9,
		},
		{
			...
			rankInfo2: [50, 70, 90],
			rankInfo3: [4, 5, 5],
			rankInfo4: ['', '', '<div class="runelvl">\n\n\n<br>Level: 4/3 (need rune)\n\n<br><br>Your Dark attacks have a <span class="tooltip-value">100%</span> chance to poison the target, which drains <span class="tooltip-value">90</span> Health each second and reduces its movement speed by <span class="tooltip-value">15%</span> for <span class="tooltip-value">5</span> seconds. <span class="tooltip-value">Reduces its movement speed by 15% when Lv4.</span></div>'],
		},
		{
			index: 25,
	...
	[
		...
		{
			index: 6,
			name: "Speed Limitation",
			ranks: 2,
			desc: "Increases the duration of the slow effect inflicted by Nightmare Termination by <span class='tooltip-value'>#</span> seconds.\n\n<b>You can increase the level of talent using runes.</b><span class='tooltip-value'>#</span>",
			rankInfo: [2, 3],
			rankInfo2: ['', '<div class="runelvl">\n\n\n<br>Level: 3/2 (need rune)\n\n<br><br>Increases the duration of the slow effect inflicted by Nightmare Termination by <span class="tooltip-value">4</span> seconds.</div>'],
		},
		{
			index: 8,
			name: "Keen Eye",
		...
		},
		{
			...
			name: "Mind Focus",
			ranks: 3,
			desc: "Reduces the cooldown of Deadly Chaser by <span class='tooltip-value'>#</span> seconds. Rank 3 increases the duration of the slow effect by 2 seconds.",
			rankInfo: [3, 6, 9],
		},
		{
			index: 16,
	...
	[
		...
		},
		{
			...
			ranks: 2,
			ranksnw: 1,
			desc: "<span class='tooltip-value'>#</span><span class='left'><span class='tooltip-value'>#</span> Mana</span><span class='right'>Cast Time: Instant</span>\n<span class='left'>Defense</span><span class='right'>Cooldown: 120 seconds</span>\n<span class='left'>Self blessing</span><span class='right'>Range: None</span>\n\nAfter two seconds, your max Health if reduced by 20%. While this effect is active, your are immune to all controlling effects. After <span class='tooltip-value'>#</span> seconds, your max Health is restored to normal.\n\n<b>You can increase the level of talent using runes.</b><span class='tooltip-value'>#</span>",
			rankInfo: ['<span class="req">Requires character to be Lv55</span>\n\n', '<span class="req">Requires character to be Lv70</span>\n\n'],
			rankInfo2: [306, 376],
			rankInfo3: [5, 7],
			rankInfo4: ['', '<div class="runelvl">\n<br>Level: 3/2 (need rune)\n\n<br><br><span class="left"><span class="tooltip-value">450</span> Mana</span><span class="right">Cast time: Instant</span>\n<br><span class="left">Defense</span><span class="right">Cooldown: 120 seconds</span>\n<br><span class="left">Self blessing</span><span class="right">Range: None</span>\n\n<br><br>After two seconds, your max Health if reduced by 20%. While this effect is active, your are immune to all controlling effects. After <span class="tooltip-value">9</span> seconds, your max Health is restored to normal.</div>'],
		},
		{
			index: 31,
			name: "Stealth Theory",
		...
		{
			index: 38,
			name: "Advanced Contract of Blood",
			ranks: 2,
			desc: "Reduces the cooldown of Contract of Blood by <span class='tooltip-value'>#</span> seconds and increases its duration by <span class='tooltip-value'>#</span> second(s).",
			rankInfo: [10, 20],
			rankInfo2: [1, 2],
			parent: 21,
		},
